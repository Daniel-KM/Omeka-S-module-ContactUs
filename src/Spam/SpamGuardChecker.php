...
/**
 * Adapter delegating the spam checks to the SpamGuard module.
 *
 * Instantiated only when SpamGuard is active. SpamGuard is the richer engine
 * (adds dnsbl, bannedIp and structured logging).
 */
